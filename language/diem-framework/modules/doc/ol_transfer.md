...
-  [Function `balance_transfer_scaled`](#0x1_TransferScripts_balance_transfer_scaled)
...
<a name="0x1_TransferScripts_balance_transfer_scaled"></a>

## Function `balance_transfer_scaled`



<pre><code><b>public</b>(<b>script</b>) <b>fun</b> <a href="ol_transfer.md#0x1_TransferScripts_balance_transfer_scaled">balance_transfer_scaled</a>(sender: signer, destination: address, value: u64)
</code></pre>
...
<pre><code><b>public</b>(<b>script</b>) <b>fun</b> <a href="ol_transfer.md#0x1_TransferScripts_balance_transfer_scaled">balance_transfer_scaled</a>(
    sender: signer,
    destination: address,
    value: u64,
) {
