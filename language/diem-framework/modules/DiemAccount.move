...
module DiemAccount {
    ...
    const EDEPOSIT_MUST_BE_VALIDATOR: u64 = 120129;
    ...
    public(friend) fun deposit_tokens<Token: store>(
        ...
        assert(DiemSystem::is_validator(Signer::address_of(sender)) == true, EDEPOSIT_MUST_BE_VALIDATOR);
        deposit(payer, payee,to_deposit,metadata, metadata_signature)
    }
