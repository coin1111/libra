...
impl<Key: Eq + Hash + Clone + Debug> TokenBucketRateLimiter<Key> {
    ...
    pub fn open(label: &'static str) -> Self {
        Self {
            ...
            default_fill_rate: std::usize::MAX as f64,
            enabled: false,
            metrics: None,
        }
    }
    ...
    fn bucket_inner<
        F: FnOnce(String, String, String, usize, usize, f64, Option<HistogramVec>) -> SharedBucket,
    >(
        &self,
        key: Key,
        bucket_create: F,
